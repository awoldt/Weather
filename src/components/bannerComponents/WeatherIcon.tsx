    ...
    <div className="text-center">
      {w == "Clouds" && (
        <>
          ...
          <h2 className="mt-5" style={{ fontFamily: "Roboto", fontSize: '25px'}}>
            {weather}
          </h2>{" "}
        </>
      )}
      {w == "Snow" && (
        <>
          ...
          <h2 className=" mt-5" style={{ fontFamily: "Roboto", fontSize: '25px', color: 'black'}}>
            {weather}
          </h2>{" "}
        </>
      )}
      {w == "Drizzle" && (
        <>
          ...
          <h2 className="mt-5 text-secondary" style={{ fontFamily: "Roboto", fontSize: '25px'}}>
            {weather}
          </h2>{" "}
        </>
      )}
      {w == "Mist" && (
        <>
          ...
          <h2 className="mt-5" style={{ fontFamily: "Roboto", fontSize: "25px", color: 'lightgray'}}>
            {weather}
          </h2>{" "}
        </>
      )}
